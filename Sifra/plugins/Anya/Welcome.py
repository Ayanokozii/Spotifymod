...
def welcomepic(pic, user, chatname, id, uname):
    ...
    font = ImageFont.truetype('Sifra/assets/font.ttf', size=110)
    welcome_font = ImageFont.truetype('Sifra/assets/font.ttf', size=60)
...
➖➖➖➖➖➖➖➖➖➖➖➖
""",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f"⦿ ᴀᴅᴅ ᴍᴇ ⦿", url=f"https://t.me/Alone_Ayano_bot?startgroup=true")]])
        )
    except Exception as e:
        LOGGER.error(e)
    try:
